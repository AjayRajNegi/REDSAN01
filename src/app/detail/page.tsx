...
// const internshipSubsections: Subsection[] = [
//   {
//     title: "Notion",
//     items: [
//       {
//         heading: "Learning what is Notion and basic tools",
//         description:
//           "Understanding Notion&apos;s core functionality, including databases, pages, and integrations.",
//       },
//       {
//         heading:
//           "How to create a client&apos;s worksheet and create content with Notion AI",
//         description:
//           "Learn how to structure client-related data and generate AI-assisted content efficiently.",
//       },
//       {
//         heading: "What is a workspace and how to create your team&apos;s workspace",
//         description:
//           "Explore the concept of workspaces, their advantages, and how to set up collaborative environments for teams.",
//       },
//       {
//         heading: "Worksheet templates and Automate scheduling meetings",
//         description:
//           "Utilize templates to streamline workflow and integrate scheduling tools for seamless meeting management.",
//       },
//     ],
//   },
//   {
//     title: "Branding Businesses",
//     items: [
//       {
//         heading: "Learning the 4Ps of Marketing and POEM framework",
//         description:
//           "Understanding Product, Price, Place, and Promotion, along with the Paid, Owned, and Earned Media (POEM) framework.",
//       },
//       {
//         heading: "How to position your brand to the right people",
//         description:
//           "Strategies to identify and engage target audiences effectively.",
//       },
//       {
//         heading:
//           "What is a LOGO, Color scheme, and creating a face of your brand",
//         description:
//           "The significance of visual branding and how to design elements that represent your brand.",
//       },
//       {
//         heading: "What is Omnichannel marketing to build your brand",
//         description:
//           "Leveraging multiple platforms to create a cohesive brand presence and customer experience.",
//       },
//       {
//         heading: "Importance of design thinking and packaging",
//         description: "",
//       },
//     ],
//   },
...
//     items: [
//       {
//         heading: "SEO and content writing",
//         description:
//           "Mastering search engine optimization and crafting compelling content to rank higher on search results.",
//       },
//       {
//         heading: "Email marketing",
//         description:
//           "Strategies for creating effective email campaigns to nurture leads and retain customers.",
//       },
//       {
//         heading: "WhatsApp marketing",
//         description:
//           "Utilizing WhatsApp for direct customer engagement and marketing automation.",
//       },
//       {
//         heading: "Ads (What is a campaign and how to draft an Ad)",
//         description:
//           "Understanding advertising campaigns and how to structure compelling ad copies.",
//       },
//       {
//         heading: "Social media marketing and creating content templates",
//         description:
//           "Developing social media strategies and designing reusable content templates for consistent branding.",
//       },
//     ],
//   },
//   {
...
//     items: [
//       {
//         heading: "How to set up your profile and optimize",
//         description:
//           "Best practices for creating a strong LinkedIn profile that stands out.",
//       },
//       {
//         heading: "How to create content: text, image, and video format",
//         description:
//           "Learning to craft engaging posts in various formats to boost visibility.",
//       },
//       {
//         heading: "How to build a network and find leads",
//         description:
//           "Strategies for growing connections and identifying potential clients or business partners.",
//       },
//       {
//         heading: "How to create your business page and hire people",
//         description:
//           "Setting up a LinkedIn business page and using LinkedIn for talent acquisition.",
//       },
//     ],
//   },
// ];

// const communitySubsections: Subsection[] = [
//   {
//     title: "Mentor Membership Benefits",
//     items: [
//       {
//         heading: "Startup Connect",
//         description: "Collaborate and consult with 1000+ startups.",
//       },
//       {
//         heading: "Guest Lecture Opportunities",
//         description: "Speak at EDC events and academic sessions.",
//       },
//       {
//         heading: "Recognition & Awards",
//         description:
//           "Receive certificates, public recognition, and annual awards.",
//       },
//       {
//         heading: "Personal Brand Building",
//         description:
//           "Enhance your brand through community involvement and media features.",
//       },
//     ],
//   },
// ];

// const Subsection = ({ title, items }: Subsection) => (
//   <div>
//     <h4 className="my-5 text-2xl font-bold">{title}</h4>
//     {items.map((item, idx) => (
...
//   <h3 className="my-5 text-3xl font-bold">{children}</h3>
// );

export default function Details() {
  return (
    <main className="h-auto bg-slate-50">
      <BackgroundBoxesDemo />
      <section>
        ...
        <article className="mx-auto w-[90%] md:w-[60%]">
          ...
          {internshipSubsections.map((section, idx) => (
            <Subsection
              key={idx}
          ...
          {/* <SectionHeading>EDC Community Benefits & Services</SectionHeading>
          {communitySubsections.map((section, idx) => (
            <Subsection key={idx} title={section.title} items={section.items} />
          ))} */}
