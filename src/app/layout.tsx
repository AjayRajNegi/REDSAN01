  ...
  return (
    <html lang="en">
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
              ...
              })(window,document,'script','dataLayer','GTM-KP8X953R');`,
          }}
        />
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-ZRMWFJQ0BT"
          strategy="afterInteractive"
        />
      ...
      <body className={`${audiowide.className} antialiased`}>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KP8X953R"
            height="0"
            width="0"
